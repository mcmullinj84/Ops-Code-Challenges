...
# Script Name:                  ops401d8-day28
# Author:                       Jonathan McMullin
# Date of latest revision:      08/15/2023
# Purpose:                      Using Handlers on logs for IP Ping and Port Scan Tool
...
# Function to send log output to a rotating file and the terminal
def setup_logging_file_and_stream():
